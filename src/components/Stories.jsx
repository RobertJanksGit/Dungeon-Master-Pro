...
const Stories = ({
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h2 className="text-3xl font-bold text-slate-200 mb-6">Story Manager</h2>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Stories List and Form */}
              ...
              <div className="grid gap-4">
                {stories.map((s) => {
                  ...
                  return (
                    <div
                      key={s.id}
                      className={`bg-slate-700 rounded-lg p-4 shadow-lg cursor-pointer transition-colors ${
                        selectedStory?.id === s.id ? "ring-2 ring-blue-500" : ""
                      }`}
                  ...
                  <div className="space-y-2">
                    ...
                    {characters.filter((char) => {
                      ...
                      <p className="text-slate-400">
                        No characters found in this campaign. Add characters to
                        the campaign first.
                      </p>
                    )}
                  </div>
        ...
        <div className="bg-slate-800 rounded-lg p-6">
          ...
          {selectedStory ? (
            ...
            <div className="text-slate-400 text-center">
              Select a story to start working with the AI assistant
            </div>
          )}
        </div>
      </div>
